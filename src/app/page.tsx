    ...
    <div className="bg-gray-50 text-gray-800">
      ...
      >
        ...
        <div className="relative z-10 p-4">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight">
            Nikmati Kelezatan Pempek{' '}
            <br className="hidden sm:inline" />
            Asli Palembang
          </h1>
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto">
            Pesan sekarang, diantar langsung ke rumahmu. Nikmati
            berbagai pilihan pempek lezat yang dibuat dengan resep
      ...
      <section id="menu" className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-xl mx-auto">
            Nikmati berbagai pilihan pempek lezat yang dibuat dengan
            resep tradisional Palembang dan bahan-bahan berkualitas
            tinggi
          </p>
      ...
      <section className="py-16 bg-gray-800 text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg text-gray-300 mb-8 max-w-xl mx-auto">
            Tidak ingin membuat akun? Tidak masalah! Anda tetap bisa
            memesan pempek favorit tanpa perlu login. Cukup masukkan
            informasi pengiriman saat checkout.
          </p>
          <Button
            size="lg"
            className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-semibold"
      ...
      <section id="tentang-kami" className="py-16 bg-white">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-xl mx-auto">
            Lihat pengalaman pelanggan yang telah mencoba pempek lezat
            dari kami
          </p>
      ...
      <section id="kontak" className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-lg mx-auto">
            Punya pertanyaan atau masukan? Jangan ragu untuk
            menghubungi kami melalui informasi kontak di bawah ini
            atau kunjungi footer.
          </p>
